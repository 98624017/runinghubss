...
- [官网明确] 页面类型：文档
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/doc-7314488.md`
- [官网明确] 页面编号：`7314488`
- [官网明确] 分类：`快捷创作`
...
![image.png](https://api.apifox.com/api/v1/projects/877857/resources/568081/image-preview)

## 二、创建任务接口
**可以根据上图页面获取各个模块api调用实例**

**请求地址**

```
POST https://www.runninghub.cn/task/openapi/quick-ai-app/run
```
...
## 三、查询任务其他相关信息，详情见基础接口
如：
[查询任务状态接口](https://www.runninghub.cn/runninghub-api-doc-cn/api-276613252)
[取消ComfyUI任务接口](https://www.runninghub.cn/runninghub-api-doc-cn/api-276613254)
[上传资源（图片、视频、音频、压缩包）](https://www.runninghub.cn/runninghub-api-doc-cn/api-276613256)
...
```
*第二步：先获取模型库风格参数数据，详情见获取快捷创作-[模型风格参数数据接口](https://www.runninghub.cn/runninghub-api-doc-cn/api-342821543)
，结果详情字段如下：*
```json
{
    "code": 0,
...
```
*第三步：如选择“【游戏】美漫画风”，根据“模型库风格参数数据”同步修改文成图API调用中nodeInfoList以下节点信息*
```json
   "nodeInfoList": [
        {
            "nodeId": "41",
