...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-335439604.md`
- [官网明确] 页面编号：`335439604`
- [官网明确] 本地文件：`references/endpoints/335439604-获取AI应用API调用示例.md`
- [官网明确] 索引摘要：提供AI应用接口请求调用示例demo，可以参考示例快速发起接口调用
- 分类：`AI 应用`
- Tags：`AI 应用`
...
- [官网明确] 方法：`GET`
- [官网明确] 路径：`/api/webapp/apiCallDemo`
