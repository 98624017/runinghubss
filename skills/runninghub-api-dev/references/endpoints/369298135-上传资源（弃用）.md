...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-369298135.md`
- [官网明确] 页面编号：`369298135`
- [官网明确] 本地文件：`references/endpoints/369298135-上传资源（弃用）.md`
- [官网明确] 索引摘要：# RunningHub 资源上传说明（图片、音视、视频、压缩包）
- 分类：`资源上传`
- Tags：`资源上传`
...
paths:
  /task/openapi/upload:
    post:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6103976/apis/api-369298135-run
components:
  schemas:
    RTaskUploadResponse:
      type: object
