...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-408103923.md`
- [官网明确] 页面编号：`408103923`
- [官网明确] 本地文件：`references/endpoints/408103923-seedream-v4.5-图生图.md`
...
- [官网明确] 方法：`POST`
- [官网明确] 路径：`/openapi/v2/seedream-v4.5/image-to-image`
...
info:
  ...
  version: 1.0.0
paths:
  /openapi/v2/seedream-v4.5/image-to-image:
    post:
      summary: seedream-v4.5-图生图
      deprecated: false
      description: ''
      tags:
      ...
      x-run-in-apifox: https://app.apifox.com/web/project/6103976/apis/api-408103923-run
components:
  schemas: {}
  securitySchemes: {}
servers:
