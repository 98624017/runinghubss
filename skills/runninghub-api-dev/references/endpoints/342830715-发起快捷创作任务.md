...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-342830715.md`
- [官网明确] 页面编号：`342830715`
- [官网明确] 本地文件：`references/endpoints/342830715-发起快捷创作任务.md`
- [官网明确] 索引摘要：在快捷创作菜单下选择需要调用的模块页中点击调用API可查看示例，可以获取到webappId、quickCreateCode、nodeInfoList等入参信息，详细请看“关于快捷创作调用”说明
- 分类：`快捷创作`
- Tags：`快捷创作`
...
- [官网明确] 方法：`POST`
- [官网明确] 路径：`/task/openapi/quick-ai-app/run`
