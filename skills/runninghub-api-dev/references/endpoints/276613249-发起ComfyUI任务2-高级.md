...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-276613249.md`
- [官网明确] 页面编号：`276613249`
- [官网明确] 本地文件：`references/endpoints/276613249-发起ComfyUI任务2-高级.md`
- [官网明确] 索引摘要：# 发起 ComfyUI 任务（高级）
- 分类：`ComfyUI 工作流`
- Tags：`ComfyUI 工作流`
