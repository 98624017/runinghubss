...
- [官网明确] 页面类型：API
- [官网明确] 官方地址：`https://www.runninghub.cn/runninghub-api-doc-cn/api-402608271.md`
- [官网明确] 页面编号：`402608271`
- [官网明确] 本地文件：`references/endpoints/402608271-全能视频S-官方-图生视频-支持真人.md`
- 分类：`标准模型 API > 视频生成 > 全能视频 S`
- Tags：`标准模型 API/视频生成/全能视频 S`

## 接口摘要

- [官网明确] 方法：`POST`
- [官网明确] 路径：`/openapi/v2/rhart-video-s-official/image-to-video-realistic`
